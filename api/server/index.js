...
const { checkMigrations, fixMissingAgentAvatars, migrateAllAvatarsToDataUri, ensureAdminRole, restrictUserAgentCreation, addRpFormattingToAgents } = require('./services/start/migration');
...
const startServer = async () => {
  ...
  app.listen(port, host, async (err) => {
    ...
    await migrateAllAvatarsToDataUri();
    await ensureAdminRole();
    await restrictUserAgentCreation();
    await addRpFormattingToAgents();
