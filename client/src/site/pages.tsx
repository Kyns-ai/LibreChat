        ...
        <div className="kyns-shell">
          <Reveal>
            <div className="site-card overflow-hidden">
              <div className="border-b border-black/6 px-6 py-4 md:px-8">
                <span className="site-eyebrow">{transparencyContent.masterPromptLabel}</span>
              </div>
              <div className="px-6 py-6 md:px-8 md:py-8">
                <pre className="overflow-x-auto whitespace-pre-wrap rounded-[24px] border border-black/6 bg-[#f4efe5] p-5 text-sm leading-7 text-[#111111]">
                  {transparencyContent.masterPrompt}
                </pre>
              </div>
            </div>
          </Reveal>
